...
<body style="background-image: url('images/pink.jpg');background-size:100%;">
  <?php include 'header.php'; ?>
  <div id="bg_index" style="height:800px" class="center title">
    <h1 style="font-size:80px;">Welcome to EventFusion</h1>
    <p>EventFusion: Where Memories Are Forged</p>
  </div >
